...
def group_chat(npcs, goal, chat_type, max_rounds, conversation_log=[]):
...
Patti is the Chief Executive Officer of Bloomberg Philanthropies and serves on the Management Committee of Bloomberg LP. Previously, she served as the First Deputy Mayor of the City of New York.
...
She also serves on the boards of the Perelman Performing Arts Center, the Public Art Fund, Franklin & Marshall College, and the National 9/11 Memorial and Museum. She previously served as a trustee of Cornell University.''',
        "Software Engineer. 5'8. Divorced. 40 years old. Has a Master's in Computer Science. Works at a tech company.",
    '''Reed Hastings 

Reed Hastings Jr. is the co-founder and Executive Chairman of Netflix, which went public in 2002. He co-founded Netflix in 1997 after he sold his first company, Pure Software, to Rational Software. He stepped down as co-CEO of Netflix in January 2023.
...
Annie Lamont co-founded Oak HC/FT in 2014 to invest exclusively in healthcare and fintech entrepreneurs. In 2023, Oak HC/FT was named as one of the ten best performing growth equity firms in the world. Annie is also the First Lady of Connecticut.
...
Charles Phillips is a Co-Founder and managing partner of Recognize, a technology investment firm focused on software engineering services. Previously, he was the Chairman and CEO of enterprise applications company Infor and President of Oracle Corporation. He served as a Captain in the U.S. Marine Corps and graduated from the Air Force Academy.
...
Patti Roskill is the Chief Financial Officer of Bloomberg LP and serves on the Management Committee of the company. She was previously a partner at Geller & Company.
...
Bob Steel is a Partner and Vice Chairman at Perella Weinberg Partners. He joined the firm in 2014 and served as CEO from 2014-2019.
...
Josh Steiner is a partner at SSW, a private investment firm, and a senior adviser at Bloomberg LP, where he previously was head of industry verticals. He also previously served as chairman of the Board of Directors at Castleton Commodities International LLC.
